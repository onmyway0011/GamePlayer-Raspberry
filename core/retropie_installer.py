...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('retropie_installer.log'),
            ...
            if returncode == 0:
                ...
                for disk in disks_data:
                    ...
                    if size > 1024**3:  # 大于1GB
                        ...
                        disks.append((device_id, f"{size_gb:.1f}GB", volume_name))
                    ...
                    for line in lines:
                        if '/dev/disk' in line and 'external' in line.lower():
                            ...
                            if len(parts) >= 3:
                                ...
                                disks.append((disk_name, size, "External Disk"))
                else:
                    # 解析 Linux lsblk 输出
                    import json
                    try:
                        ...
                        for device in data.get('blockdevices', []):
                            if device.get('type') == 'disk':
                                ...
                                disks.append((name, size, mountpoint or "Unmounted"))
