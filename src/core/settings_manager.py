...
class SettingsManager:
    ...
    def update_input_settings(self, settings: Dict):
        """更新输入设置"""
        try:
    ...
    def update_key_mapping(self, player: int, action: str, key: str):
        """更新按键映射"""
    ...
    def is_feature_enabled(self, feature_path: str):
        """检查功能是否启用"""
    ...
    def apply_raspberry_pi_optimizations(self):
        """应用树莓派优化"""
        try:
