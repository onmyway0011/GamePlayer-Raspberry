...
class EmulatorStartupFixer:
    ...
    def test_emulator(self, emulator_name: str, test_args: list) -> bool:
        """测试模拟器是否可用"""
    ...
    def install_emulator(self, install_command: str) -> bool:
        """安装模拟器"""
    ...
    def fix_system_emulator(self, system: str) -> bool:
        """修复指定系统的模拟器"""
        print(f"\n🎮 修复 {system.upper()} 模拟器...")
    ...
    def test_emulator_with_rom(self, system: str, emulator_name: str, rom_path: str) -> bool:
        """使用ROM测试模拟器启动"""
